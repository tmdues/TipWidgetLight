...
public class CalculatorActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		back.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (results.getText().toString().length() == 0) {
					...
					results.setText((results.getText().toString().substring(0,
							results.getText().toString().length() - 1)));
				}
			}
		});
		plus.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (plus_clicked == true) {
					...
					if (r1 != "") {
						r2 = results.getText().toString();
						if (minus_clicked == true || divide_clicked == true
		...
		minus.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (minus_clicked == true) {
					...
					if (r1 != "") {
						r2 = results.getText().toString();
						if (plus_clicked == true || divide_clicked == true
								|| multiply_clicked == true) {
							calculator(r1, r2);
							if (r1.length() > 11) {
								r1 = "Overflow";
		...
		divide.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (divide_clicked == true) {
					...
					if (r1 != "") {
						r2 = results.getText().toString();
						if (plus_clicked == true || minus_clicked == true
								|| multiply_clicked == true) {
							calculator(r1, r2);
							if (r1.length() > 11) {
								r1 = "Overflow";
		...
		zero.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (results.getText().toString().contains(".")) {
					if (results.getText().toString().indexOf(".") + 2 >= results
		...
		one.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (onStart == true
						|| results.getText().toString() == "Overflow") {
					onStart = false;
					Clear();
					results.setText("0");
				}
		...
		equal.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				if (r1 != "" & resultOnSubmit != "") {
					String temp = calculator(r1, resultOnSubmit);
					if (temp.length() > 11) {
						temp = "Overflow";
					}
					results.setText(temp);
	...
	public String calculator(String res1, String res2) {
		if (res1 == "Overflow" || res2 == "Overflow") {
			res1 = "0";
			res2 = "0";
		}
		String answer = "";
		...
		if (equal_clicked = true) {
			if (plus_clicked == true) {
				answer = String.valueOf(Double.parseDouble(res1)
						+ Double.parseDouble(res2));
				r1 = answer;
				r2 = "";
				...
				if (String.valueOf(t).contains(".")) {
					if (String
							.valueOf(t)
							.substring(String.valueOf(t).indexOf("."),
									String.valueOf(t).length()).length() >= 2) {
						...
						r2 = "";
							...
							.valueOf(t)
							.substring(String.valueOf(t).indexOf("."),
									String.valueOf(t).length()).length() >= 1) {
